...
CREATE PROCEDURE `UpdateMarriageStartDate`(
    ...
    COMMENT 'Update start date of active marriage for a pair with overlap validation against all other marriages for both persons'
BEGIN
    ...
    SET NewTransNo = GetTranNo('UpdateMarriageStartDate');
    ...
    main_proc: BEGIN
        ...
        START TRANSACTION;
            ...
            VALUES (
                CONCAT(
                    'TransNo-', NewTransNo,
                    ': UpdateMarriageStartDate update MarriageID=', ActiveMarriageId,
